...
PPO_MICRO_BATCH_SIZE_PER_GPU=${PPO_MICRO_BATCH_SIZE_PER_GPU:-3}
LOG_PROB_MICRO_BATCH_SIZE_PER_GPU=${LOG_PROB_MICRO_BATCH_SIZE_PER_GPU:-3}
...
export SWANLAB_API_KEY=${SWANLAB_API_KEY:-OyVZPve2Ckn6i51nZdLHs}
